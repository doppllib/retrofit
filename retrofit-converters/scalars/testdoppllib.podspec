...
Pod::Spec.new do |s|
  ...
  TODO: Add long description of the pod here.
    ...
    s.source_files = FileList["build/testdoppllib.h"].include("build/dopplBuild/dependencies/out/main/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/source/out/main/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_com_squareup_okio_okio_1_13_0_0/src/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_lib_androidbase_0_8_8_0/src/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/dependencies/out/test/**/*.{h,m,cpp,properites,txt}").include("build/dopplBuild/source/out/test/**/*.{h,m,cpp,properites,txt}").include("build/classes/main/**/*.java").include("build/generated/source/apt/main/**/*.java").include("src/main/java/**/*.java").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_com_squareup_okhttp3_okhttp_ws_3_4_2_6/java/**/*.java").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_com_squareup_retrofit2_urlsession_retrofit_2_3_0_9/java/**/*.java").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_com_squareup_okhttp3_okhttp_3_4_2_6/java/**/*.java").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_com_squareup_okio_okio_1_13_0_0/java/**/*.java").include("build/dopplBuild/dependencies/exploded/doppl/co_doppl_lib_androidbase_0_8_8_0/java/**/*.java").include("build/classes/test/**/*.java").include("build/generated/source/apt/test/**/*.java").include("src/test/java/**/*.java").include("build/dopplBuild/dependencies/exploded/testDoppl/co_doppl_lib_androidbasetest_0_8_8_0/java/**/*.java").include("build/dopplBuild/dependencies/exploded/testDoppl/co_doppl_junit_junit_4_12_0/java/**/*.java").include("build/dopplBuild/dependencies/exploded/testDoppl/co_doppl_com_squareup_okhttp3_mockwebserver_3_4_2_6/java/**/*.java").include("build/dopplBuild/dependencies/exploded/testDoppl/co_doppl_org_assertj_assertj_core_1_7_0_5/java/**/*.java").include("build/dopplBuild/dependencies/exploded/testDoppl/co_doppl_org_hamcrest_hamcrest_core_1_3_0/java/**/*.java").to_ary
